"""
Django settings for jxwewr_82 project.
...
WSGI_APPLICATION = 'jxwewr_82.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "jxwewr_82 API",
    "DESCRIPTION": "API documentation for jxwewr_82 App",
    "VERSION": "v1",
}
